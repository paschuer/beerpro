...
public class Fridge implements Entity {
    ...
    public Fridge(String userId, String beerId, Date addedAt) {
        this.userId = userId;
        this.beerId = beerId;
    ...
    private boolean canEqual(final Object other) {
        return other instanceof Fridge;
    }
    ...
    public String toString() {
        return "Fridge(id=" + this.getId() + ", userId=" + this.getUserId() + ", beerId=" + this.getBeerId() + ", addedAt=" + this.getAddedAt() + ")";
    }
}
