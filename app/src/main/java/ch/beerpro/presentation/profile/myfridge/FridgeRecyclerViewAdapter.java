...
public class FridgeRecyclerViewAdapter extends ListAdapter<Pair<Fridge, Beer>, FridgeRecyclerViewAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Fridge fridge, Beer item, OnFridgeItemInteractionListener listener) {
            ...
            String formattedDate =
                    DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.SHORT).format(fridge.getAddedAt());
